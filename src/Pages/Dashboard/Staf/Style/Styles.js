const styles = {
  ...
  pinkbutton:
    'flex font-bold rounded-md text-sm text-white bg-rose-500 border-rose-600 border-2 hover:border-pink-600 hover:text-pink-600 hover:bg-gradient-to-r hover:from-white hover:to-white border  py-1.5 w-full flex justify-center focus:outline-none',
  tablehead:
    'py-3 px-3 text-xs font-medium tracking-wider text-left text-black uppercase',
  redbutton:
  ...
  input:
    'border-0 border px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring-rose-500 w-full ease-linear transition-all duration-150',
