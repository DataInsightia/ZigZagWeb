              ...
              <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                ...
                <div className="mt-2">
                  <form encType='multipart/formdata' onSubmit={(e) => { updateButton(e, currentProduct.product_id); closeUpdateModal(e); }}>
                   ...
                   <label className={ currentProduct.display ? 'button border-none rounded-2xl bg-green-500 text-white font-bold' : 'button border-none rounded-2xl bg-red-500 text-white font-bold'}><input type="button" onClick={(e) => handleCurrentToggler(e,currentProduct.display)} defaultValue={currentProduct.display ? "Click to Hide " : "Click to Show "} name="display" /> Product</label><br />
                    <label className={ currentProduct.new_arrival ? 'button border-none rounded-2xl bg-green-500 text-white font-bold' : 'button border-none rounded-2xl bg-red-500 text-white font-bold'}><input type="button" onClick={(e) => handleCurrentToggler(e,currentProduct.new_arrival)} defaultValue={currentProduct.new_arrival ? "Click to Hide " : "Click to Show "} name="new_arrival" /> New Arrival</label><br />
