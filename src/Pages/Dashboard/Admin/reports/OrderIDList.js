...
export default function OrderIDList() {
  ...
  const orderSearch = (event) => {
    ...
    let value = event.target.order.value
    axios.get(`${API}/api/order_filter/?order_id=${value}`).then((res) => {
      if (res.status === 200) {
...
function Pagination({ Orderstate = { Orderstate }, orderSearch, Order }) {
    ...
    <div>
      <div className="scroll md:mt-16 justify-center w-full min-h-screen">
        <div className=" overflow-auto overflow-x-scroll bg:hidden  p-4">
            <p className="uppercase font-bold">Filter By Order ID</p>
          <div className="py-4">
            ...
            <div className="flex flex-wrap justify-between my-5 md:mb-0">
              <div className="md:w-full flex overflow-auto px-2 pb-1">
                    ...
                    <div className="flex justify-between">
                      <div className="px-2">
                        <input
                          ...
                          placeholder="Search"
                          name="order"
                          className="shadow-lg border-none uppercase pr-2 px-3 py-3 placeholder-blueGray-300 text-black bg-white rounded-md text-sm  w-full  ease-linear transition-all duration-150"
                        />
                      </div>
                      <div className="px-2">
                        <input
