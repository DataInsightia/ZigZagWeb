...
export default function Register() {
  ...
  const [code, setCode] = useState({'countryCode':'91'})
  ...
  const onSubmit = (e) => {
    ...
    const country_code = code.countryCode
    axios
  ...
  const is_user = (e, mobile) => {
    axios
      .post(`${API}/api/is_user/`, { cust_id: mobile })
      .then((res) => {
        if (res.data.status) {
          alert(res.data.message)
          e.target.value = ''
                          ...
                          startAdornment: (
                            ...
                            >
                              <select
                                ...
                                className="h-auto w-36 border-hidden outline-none"
                              >
                                <option
                                  data-countryCode="IN"
                                  value="91"
