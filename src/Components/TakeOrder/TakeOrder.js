              ...
              <div className="mt-10 flex flex-wrap justify-evenly bg-white shadow-2xl  justify-center ">
                  ...
                  <div className="grid mt-12">
                     <div className="flex flex-wrap">
                         ...
                         Customer Id:{customer_details.cust_id}</div>
                      <div className="flex flex-wrap">
                          <div className=" w-10 h-10">
                              <img
                                  className="w-full h-full rounded-full"
                                  src={'https://static.thenounproject.com/png/1946983-200.png'}
                                  alt=""
                              />
                          </div>
                          Name :{customer_details.cust_name}</div>
                      <div className="flex flex-wrap">
                          <div className=" w-10 h-10">
                              <img
                                  className="w-full h-full rounded-full"
                                  src={'https://cdn.icon-icons.com/icons2/2248/PNG/512/phone_icon_136322.png'}
                                  alt=""
                              />
                          </div>
                          Mobile :{customer_details.mobile}</div>
                      <div className="flex flex-wrap">
                          <div className=" w-10 h-10">
                              <img
                                  className="w-full h-full rounded-full"
                                  src={'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnpdHWJg7i_tQSZnkW-0Ovp9ORPGcBLB4q7Q&usqp=CAU'}
                                  alt=""
                              />
                          </div>
                          Email:{customer_details.email}</div>
