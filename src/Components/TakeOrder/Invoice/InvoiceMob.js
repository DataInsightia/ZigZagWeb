...
export default function InvoiceMob(){
    ...
    return (
        ...
        <div ref={componentRef} className="flex items-center mt-16 ml-10 mr-10 justify-center min-h-screen mx-auto my-auto">
            <div className="md:w-1/2 overflow-auto bg-white shadow-lg">
                <div className="">
